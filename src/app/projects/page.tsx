...
export default function ProjectsPage() {
  ...
  const projects = [
    ...
    },
    {
      ...
      tags: ['Website Design', 'UX/UI Design', 'Cafe Type'],
      description: 'Coffee Shop Website is a modern website designed to showcase a coffee shop’s menu, services, and atmosphere, helping customers explore offerings and connect easily with the shop.',
      image: '',
      categories: ['Website Design', 'UX/UI Design'],
    },
    {
      title: 'Professional Portfolio Website',
      tags: ['Website Design', 'UX/UI Design', 'Personal'],
      description: 'Professional Portfolio Website is a user-friendly website designed to showcase professional experience, projects, skills, and education, helping visitors easily understand the individual’s profile.',
      image: '',
      categories: ['Website Design', 'UX/UI Design'],
    },
  ];
